...
private:
	...
	static NOINLINE Void GetLockCount(){ return _pScheduler->_schedulerLock; }

	static NOINLINE Void SetLockCount(U32 newlock){ _pScheduler->_schedulerLock = newlock; }

	static NOINLINE Void lock()
	{
		_pScheduler->_schedulerLock++;
	}
	
	static NOINLINE Void unlock()
	{
