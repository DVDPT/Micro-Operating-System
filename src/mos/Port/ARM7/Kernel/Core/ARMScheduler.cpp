...
NAKED void UScheduler::ContextSwitch(Thread* oldThread, Thread* newThread)
{
	...
	(
		...
		///
		///	Save this thread program counter in case that it switchs via interrupt
		///
		"push {lr}\n"
		...
		///
		///	Set stack 4 (4registers * 32bits = 16 bytes) positions under (r0-r3) registers don't need to be saved
		///
		"sub sp,sp,#16 \n"
