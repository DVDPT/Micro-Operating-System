...
//
//template <typename Context>
//Void BaseUtThread<Context>::UtThreadStart()
//{
//	BaseUtThread<Context>& thread = BaseUtScheduler::GetRunningThread();
//	thread->m_func(thread->m_arg);
//
//}
//
//template <typename Context>
//BaseUtThread<Context>& BaseUtThread<Context>::GetCurrentThread()
//{
//	return BaseUtScheduler::GetRunningThread();
//}